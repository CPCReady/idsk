...
int main(int argc, char **argv)
{
	...
	if (!IsDskSet)
	{
		cerr << "\nError: You did not select a DSK file to work with !" << endl;
		help();
	}
	else
	...
	if (ModeListBasic || ModeListHex || ModeListDams || ModeDisaFile || ModeListAscii)
	{
		...
		for (vector<string>::iterator iter = AmsdosFileList.begin(); iter != AmsdosFileList.end(); iter++)
		{
			...
			if (ModeListBasic)
				cout << endl << ViewBasic(Split_lines) << endl;
...
void help(void)
{
	...
	cout << "Enhanced version with additional features for CPCReady" << endl;
	cout << "Enhanced features (C) 2025 Destroyer" << endl;
	cout << "--------------------------------------------------------------------------------" << endl;
	cout << endl;
	cout << "Usage : " << endl;
	...
	cout << "--------------------------------------------------------------------------------" << endl;
	cout << "CPCReady Enhanced Features (C) 2025 Destroyer:" << endl;
	cout << "  • Internationalized interface (English)" << endl;
	cout << "  • Clean output format with disk usage info" << endl;
	cout << "  • Compact file size display (K format)" << endl;
	cout << "  • Automatic Unix to DOS line ending conversion for BASIC files (.bas)" << endl;
	cout << "  • Improved BASIC program display with proper line separation" << endl;
	cout << "  • Improved user experience and readability" << endl;
	cout << "--------------------------------------------------------------------------------" << endl;
